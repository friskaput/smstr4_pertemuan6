                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-danger">Hapus</a><?= $this->extend('layout/template'); ?>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><small
                                                                class="text-body-secondary"><b>Penerbit :
                                                                </b><?= $buku['penerbit']; ?></small></p>

                                                        <a href="#" class="btn btn-warning">Ubah</a>
                                                        <a href="#" class="btn btn-danger">Hapus</a>
                                                        <br><br>
                                                        <a href="/books" class="btn btn-secondary">Kembali ke daftar
                                                            buku</a>
                                                    </div>
                                                </div>
                                            </div>
